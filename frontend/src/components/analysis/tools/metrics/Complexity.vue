...
const createTodayData = () => {
  return HistoricalMetrics.createFrom({
    ...
    metrics: Metrics.createFrom({
      cyclomatic_complexity_avg: props.data.AverageComplexity,
    })
  });
}
...
const resolveChartData = () => {
  ...
  localData.historical.forEach(value => {
    complexityData.push(value.metrics.cyclomatic_complexity_avg)
  })
...
<template>
    ...
    <div class="card-header">
      ...
      <div class="text-right">
        <div class="btn btn-sm btn-default action" title="View Metrics Chart"
             data-toggle="modal" data-target="#modal-complexity-metrics-chart" v-on:click="showChart">
        ...
        <li class="list-group-item">
          ...
          <div class="float-right">
            ...
            <i v-if="props.previous != undefined"
               :class="resolveIcon(props.data.average_complexity, props.previous.cyclomatic_complexity_avg)"
               :style="resolveStyle(props.data.average_complexity, props.previous.cyclomatic_complexity_avg)"
               :title="resolveHint(props.data.average_complexity, props.previous.cyclomatic_complexity_avg)"
            ></i>
          </div>
        </li>
        <li class="list-group-item">
  ...
  <div class="modal fade" id="modal-complexity-metrics-chart" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title">Cyclomatic Complexity Chart</h4>
